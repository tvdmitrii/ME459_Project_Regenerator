...
void RegenHX::set_params(int target_1, int target_2, int operation_mode, int valveMode, double target_2_value, double P_0, double D_s, double e_v, double Q_dot_loss, double AR_guess, double V_0_guess)
{
...
void RegenHX::setParameters(valveDesignOption::valveDesignOption operationMode, valveDesignOption::valveModes valveMode, double Q_dot_loss, double P_0, double D_s, double e_v)
{
	...
	regenModel->setParameters(valveMode, Q_dot_loss, P_0, D_s, e_v, AR_guess, V_0_guess);
}
